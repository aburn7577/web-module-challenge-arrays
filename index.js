...
function copy(originalFlavors){
   let flavorsCopy = [...originalFlavors];
   return flavorsCopy 
}    
...
console.log(removeLastFlavor(copy(originalFlavors)))
...
console.log(getFlavorByIndex(copy(originalFlavors), 2))
...
console.log(removeFlavorByName(copy(originalFlavors), "Rocky Road"))
...
function filterByWord(array, flavor){
 ...
 console.log(filterByWord(copy(originalFlavors), 'Chocolate'));
